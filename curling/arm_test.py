...
from bosdyn.api import (arm_command_pb2, manipulation_api_pb2, geometry_pb2, robot_command_pb2, synchronized_command_pb2,
                        trajectory_pb2, image_pb2, estop_pb2)
...
def arm_test(config):
    ...
    # Not the estop.
        robot.logger.info("Estop client failed")
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        while True:
            ...
            if response.current_state == manipulation_api_pb2.MANIP_STATE_GRASP_SUCCEEDED:
                raise_gripped_arm(robot, command_client)
                break
...
def raise_gripped_arm(robot, command_client):
